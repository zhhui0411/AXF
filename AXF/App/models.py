...
class Address(models.Model):
    ...
    地址：
        用户a_user
        收货人  电话  住址  邮编(a_receiver,a_tel,a_address,a_postcode)
    '''
    a_user = models.ForeignKey(AXFUser)
    a_receiver = models.CharField(max_length=32)
    a_tel = models.IntegerField()
    a_address = models.CharField(max_length=256)
    a_postcode = models.IntegerField(default=000000)
